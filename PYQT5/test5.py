...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(80, 91, 301, 71))
        font = QtGui.QFont()
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(430, 90, 281, 71))
        font = QtGui.QFont()
        font.setPointSize(22)
        ...
        self.label.setGeometry(QtCore.QRect(250, 220, 291, 81))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(290, 350, 181, 81))
        font = QtGui.QFont()
        font.setPointSize(22)
    ...
    def pressed(self):
        ...
        xor=1 if x!=y else 0
        self.label.setText("XOR="+str(xor))
